...
export const WEB3_CHAPTERS: Web3Chapter[] = [
  ...
  },
  {
    ...
    title: { zh: "经济形势与 Web3 机遇", en: "Macro Trends and Web3 Opportunities" },
  ...
  },
  {
    ...
    title: { zh: "参与 Web3 的门户", en: "Your Gateway to Web3" },
...
export const WEB3_GUIDE_SECTIONS = [
  ...
  { id: "economy", icon: "📈", label: { zh: "经济形势与机遇", en: "Macro Opportunity" } },
  { id: "invest", icon: "🔄", label: { zh: "投资方式", en: "Ways to Participate" } },
  { id: "start", icon: "🚀", label: { zh: "如何开始", en: "How to Start" } },
] as const;
