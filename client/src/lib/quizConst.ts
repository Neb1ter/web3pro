...
export const ALL_STEPS: LearningStep[] = [
  ...
  { id: "crypto-saving", icon: "💰", title: "省钱指南", titleEn: "Fee Saving Guide", description: "通过返佣机制降低交易手续费", descriptionEn: "Reduce trading fees through referral rebate mechanisms", path: "/crypto-saving", duration: "10 分钟", durationEn: "10 min", difficulty: "beginner", tags: ["saving", "exchange"] },
