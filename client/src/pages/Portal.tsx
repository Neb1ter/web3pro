...
const LANG = {
  zh: {
    ...
    h1b: " Get8 Pro ",
    h1c: "",
    h1sub: "Web3教程, 交易所返佣, 币圈入门一站式平台",
    desc: "探索Web3世界，获取最高交易返佣——从Get8 Pro开始。",
    ...
    lockLabel: "敬请期待",
    footerCopy: "© 2026 Get8 Pro · Web3教程, 交易所返佣, 币圈入门一站式平台",
  ...
  en: {
    ...
    h1b: " Get8 Pro ",
    h1c: "",
    h1sub: "Your Guide to Web3 - Crypto Exchange Tutorials for Beginners",
    desc: "Get 8, Get Pro. Learn Web3, Blockchain, and Crypto All in One Place. Master Exchanges with Our Guides & Tips.",
    ...
    footerCopy: "© 2026 Get8 Pro · Get 8, Get Pro. Your Guide to Web3 & Crypto Exchange Rebates.",
