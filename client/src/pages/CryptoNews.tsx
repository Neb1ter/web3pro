          ...
          {filtered.map((article: {
            ...
            return (
              <Link
                ...
                className="tap-target group rounded-xl border border-gray-700/60 bg-gray-800/40 hover:border-cyan-500/40 hover:shadow-[0_0_20px_rgba(6,182,212,0.06)] transition-all duration-200 overflow-hidden"
              >
                  {article.coverImage && (
