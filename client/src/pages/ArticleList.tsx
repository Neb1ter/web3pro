        ...
        <div className="max-w-5xl mx-auto px-4 py-10">
              ...
              {filtered.map(article => {
                ...
                return (
                  <Link
                    ...
                    className="tap-target group bg-white/5 border border-white/10 rounded-xl p-5 hover:bg-white/8 hover:border-white/20 transition h-full flex flex-col"
                  >
                      {/* 分类标签 */}
          ...
          <div className="mt-12 border-t border-white/10 pt-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Link href="/exchanges" className="tap-target flex items-center justify-between bg-white/5 border border-white/10 rounded-xl p-4 hover:bg-white/10 transition">
                  <div>
              ...
              <Link href="/crypto-saving" className="tap-target flex items-center justify-between bg-white/5 border border-white/10 rounded-xl p-4 hover:bg-white/10 transition">
                  <div>
              ...
              <Link href="/web3-guide" className="tap-target flex items-center justify-between bg-white/5 border border-white/10 rounded-xl p-4 hover:bg-white/10 transition">
                  <div>
