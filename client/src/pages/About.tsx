        ...
        <div className="max-w-4xl mx-auto px-4 py-12 space-y-16">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {PARTNERSHIPS.map((p, i) => (
                <Link key={i} href={p.href} className="tap-target flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-4 hover:bg-white/10 hover:border-white/20 transition">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/contact" className="tap-target flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-5 hover:bg-white/10 transition">
